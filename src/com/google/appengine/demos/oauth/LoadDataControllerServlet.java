...
public class LoadDataControllerServlet extends ControllerServlet {
  ...
  protected RequestInfo handleGet(HttpServletRequest request,
    ...
    System.out.println("OAuth Access Token: " + userInfo.getAccessToken()); 
    ...
    //request.setAttribute("Authorization", "OAuth");
    ...
    try {
      ...
      URL feedUrl1 = new URL("http://www.google.com/m8/feeds/contacts/default/full");
